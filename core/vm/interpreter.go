...
func (in *EVMInterpreter) Run(contract *Contract, input []byte, readOnly bool) (ret []byte, err error) {
	...
	for {
		...
		if operation.dynamicGas != nil {
			...
			dynamicCost, err = operation.dynamicGas(in.evm, contract, stack, mem, memorySize, nil)
...
func (in *EVMInterpreter) Run_new(txExtra *types.TxExtra, contract *Contract, input []byte, readOnly bool) (ret []byte, err error) {
	// Increment the call depth which is restricted to 1024
	in.evm.depth++
	defer func() { in.evm.depth-- }()
